...
onMounted(async () => {
  ...
  nowPlayingRepsonses.value = responses.value.now_playing || []
  stopPlayingRepsonses.value = responses.value.stop_playing || []
  nextPlayingRepsonses.value = responses.value.next_playing || []
  helpRepsonses.value = responses.value.help || []
